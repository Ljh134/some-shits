...
//here is the subscriber framework
//here is the inheritance from rclcpp::Node
  SimpleSubscriber() : Node("simple_subscriber")
  {
    //set a subscription from topic "pos" queue size 512
    //once receive a message , call the topic_callback function
    //the last2 parameters is the function binded with this class(打酱油的)
...
// processing the received message
  ...
  { 
    ...
    //logger (show the message is resived)
    ...
    //sorry i forgot how to make this part but maybe check the message ? just skip it , it doesn't matter
  ...
  //create s shared subscription pointer
